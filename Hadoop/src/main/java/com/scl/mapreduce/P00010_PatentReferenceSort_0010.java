...
public class P00010_PatentReferenceSort_0010 extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception{
		...
		Path temp=new Path(conf.get("temp","temp"));
	...
	public static void main(String[] args) throws Exception{
		System.exit(ToolRunner.run(new P00010_PatentReferenceSort_0010(),args));
	}
}
